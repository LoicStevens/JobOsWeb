          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="mt-6 flex justify-center space-x-4">
                <button className="bg-bg-transparent text-white  border-2 border-bgcustom-green hover:bg-bgcustom-green   font-bold py-3 px-6  shadow-lg transition duration-300 ease-in-out transform hover:scale-105">
                  Find Jobs
                </button>
                <button className="bg-bgcustom-green text-white border-2 border-bgcustom-green hover:bg-transparent hover:text-bgcustom-green font-bold py-3 px-6  shadow-lg transition duration-300 ease-in-out transform hover:scale-105">
                  Hire Provider
                </button>
              </div>
            </div>
